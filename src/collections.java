...
public class collections {
	...
	public static void main(String[] args) {
		/*why would we use a StringBuilder over a String
		 * String cannot be changed = immutable 
		 * string builder is mutable (We can take away or add) saves memory
		 */
		...
		List<String> strings = new ArrayList<String>();		//Arrays.asList("Tom", "Sammy") could replace the second part of this line
		strings.add("Tali");
		strings.add("Sammy");
		strings.add("Paul");
		strings.add("I");
		...
		List<Integer> stringsLenghts = calculateStringLengths(strings);
		...
		List<String> resultsList = convertSetToList(set);
		
		for (String listString : resultsList) {
		...
		Map<Character, Integer> counts = countStartingLetters(resultsList);
